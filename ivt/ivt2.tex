...
number \wordChoice{\choice[correct]{$c$}\choice{$f(c)$}} in
  \wordChoice{\choice{$[f(a),f(n)]$}\choice[correct]{$[a, n]$}} such that
  \wordChoice{\choice[correct]{$f(c) = v$},\choice{$f(v) = c$}}.
\end{theorem}
\begin{hint}
...
\begin{axis}[
            ...
            xticklabels={$a$,$c$,$n$}, yticklabels={$f(a)$,$v$,$f(n)$},
            axis on top,
          ]
