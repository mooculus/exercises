...
\begin{enumerate}
\item Find the left Riemann Sum for $n$ equally spaced rectangles approximating $\int_{1}^{4}2x^2-3\d x$ \begin{prompt}\[\int_{1}^{4}2x^2-3\d x\approx\answer{33+\frac{9}{n^2}-\frac{45}{n}}\]
\end{prompt}
\item Compute the limit as $n\to\infty$ of your answer
  above. \begin{prompt}\[\answer{33}\]
  \end{prompt}
