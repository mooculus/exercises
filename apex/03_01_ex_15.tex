...
Find where the absolute minima and maxima of $f(x)=x^2+x+4$ occur on $[-1,2]$.

\[
min: x\begin{prompt} = \answer{\{-\frac{1}{2}\}}\end{prompt}
\]
\[
max: x\begin{prompt} = \answer{\{2\}}\end{prompt}
\]
