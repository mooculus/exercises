...
\begin{enumerate}
\item		The domain of $f$ is $\answer{(-\infty,-1)\cup(-1,1)\cup(1,\infty)}$.
\item		$f$ has a critical point(s) at $x = \answer{0}$, write DNE if no such point(s) exist.
\item		$f$ is decreasing on $\answer{(-\infty,-1)\cup(-1,0)}$, write DNE if no such interval(s) exist.
\item		$f$ is increasing on $\answer{(0,1)\cup(1,\infty)}$ write DNE if no such interval(s) exist.
\item		At $x=0$, $f$ has 
