...
Find where the absolute minima and maxima (entered from least to greatest) of $f(x)=\frac{\ln(x)}{x}$ occur on $[1,4]$.

The absolute minima occur at
\[
x\begin{prompt} = \answer{1}\end{prompt}
\]

The absolute maxima occur at
\[
x\begin{prompt} = \answer{e}\end{prompt}
\]
