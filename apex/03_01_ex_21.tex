...
Find where the absolute minima and maxima of $f(x)=e^{x}\cos(x)$ occur on $[0,\pi]$.

\[
min: x\begin{prompt} = \answer{\{\pi\}}\end{prompt}
\]
\[
max: x\begin{prompt} = \answer{\{\pi/4\}}\end{prompt}
\]
