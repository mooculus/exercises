...
Find where the absolute minima and maxima of $f(x)=x^3-\frac{9}{2}x^2-30x+3$ occur on $[0,6]$.

\[
min: x\begin{prompt} = \answer{\{5\}}\end{prompt}
\]
\[
max: x\begin{prompt} = \answer{\{0\}}\end{prompt}
\]
