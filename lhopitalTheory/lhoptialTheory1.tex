...
\[
\lim_{x \to \infty} \frac{e^{-x}+1}{1+\frac{1}{x}}
\]
...
\begin{prompt}
	...
	\choice[correct]{l'H\^{o}pital's rule does not apply since the limit is not an indeterminate form }
...
If the limit does not exist, write $DNE$.
	...
	\[
	\lim_{x \to \infty} \frac{e^{-x}+1}{1+\frac{1}{x}} = \answer{1}
	\]
\end{prompt}
