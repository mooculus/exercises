...
If the blue point has abscissa $a$, which of the following is true?
...
\begin{tikzpicture}
	\begin{axis}[
	   ...
	   %xtick={-4,...,4}, ytick={-3,...,3},
          ...
          \addplot [very thick, penColor3!20!penColor2, samples=1000,smooth, domain=(-6:6)] {cos(deg(x))};
          \addplot[color=penColor,fill=penColor,only marks,mark=*] coordinates{(1,0.54030230586)};  %% closed hole
