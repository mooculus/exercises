...
\begin{tikzpicture}
	\begin{axis}[
	   ...
	   %xtick={-4,...,4}, ytick={-3,...,3},
          ...
          \addplot [very thick, penColor3!20!penColor2, samples=1000,smooth, domain=(-5:6)] {sin(deg(x))};
          \addplot[color=penColor,fill=penColor,only marks,mark=*] coordinates{(1,0.8414709848)};  %% closed hole
