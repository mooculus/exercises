...
\begin{enumerate}
\item Using the graph below, estimate   $ f'(2)$.

\begin{prompt}
$$\left. \ddx f(x)\right|_{x =2} \approx \answer{0}$$
\end{prompt}
...
\item  Using your estimate above, what is the equation of the tangent line to $f$ at $x=2$?
