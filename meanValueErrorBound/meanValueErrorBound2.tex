...
First, use the local linearization of $\frac{1}{x}$ at $x=1$ to approximate $\\frac{1}{1.1}$ by hand.  Then show rigorously, using the mean value theorem, that your estimate cannot be off by more than $0.1$. 
